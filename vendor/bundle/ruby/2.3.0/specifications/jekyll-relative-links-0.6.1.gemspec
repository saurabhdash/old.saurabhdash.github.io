...
Gem::Specification.new do |s|
  ...
  if s.respond_to? :specification_version then
    ...
    if Gem::Version.new(Gem::VERSION) >= Gem::Version.new('1.2.0') then
      s.add_runtime_dependency(%q<jekyll>, ["< 5.0", ">= 3.3"])
      s.add_development_dependency(%q<rspec>, ["~> 3.5"])
      s.add_development_dependency(%q<rubocop>, ["~> 0.71"])
      s.add_development_dependency(%q<rubocop-jekyll>, ["~> 0.10"])
    else
      s.add_dependency(%q<jekyll>, ["< 5.0", ">= 3.3"])
      s.add_dependency(%q<rspec>, ["~> 3.5"])
      s.add_dependency(%q<rubocop>, ["~> 0.71"])
      s.add_dependency(%q<rubocop-jekyll>, ["~> 0.10"])
    end
  else
    s.add_dependency(%q<jekyll>, ["< 5.0", ">= 3.3"])
    s.add_dependency(%q<rspec>, ["~> 3.5"])
