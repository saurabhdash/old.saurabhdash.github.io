...
Gem::Specification.new do |s|
  ...
  if s.respond_to? :specification_version then
    ...
    if Gem::Version.new(Gem::VERSION) >= Gem::Version.new('1.2.0') then
      s.add_runtime_dependency(%q<jekyll-commonmark>, ["~> 1.2"])
      s.add_runtime_dependency(%q<commonmarker>, ["~> 0.17.6"])
      s.add_runtime_dependency(%q<rouge>, ["< 4.0", ">= 2.0"])
      s.add_development_dependency(%q<rspec>, ["~> 3.0"])
      s.add_development_dependency(%q<rake>, [">= 0"])
    else
      s.add_dependency(%q<jekyll-commonmark>, ["~> 1.2"])
      s.add_dependency(%q<commonmarker>, ["~> 0.17.6"])
      s.add_dependency(%q<rouge>, ["< 4.0", ">= 2.0"])
